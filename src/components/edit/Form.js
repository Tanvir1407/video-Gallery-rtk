...
export default function Form({ video }) {
    ...
    const {title:initialTitle, author:initialAuthor, description:initialDescription, link:initialLink, thumbnail:initialThumbnail, date:initialDate, duration:initialDuration, views:initialViews } = video;
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className="shadow overflow-hidden sm:rounded-md">
                ...
                {isError && <Error message="Something Error to Add New Video" />}
